...
HD_PWD='C:/Users/lazar/Documents/risc-v/RISC-V.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TOP_RISCV.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TOP_RISCV.tcl
