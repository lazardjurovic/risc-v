...
HD_PWD='C:/Users/lazar/Documents/risc-v/RISC-V.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TOP_RISCV.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TOP_RISCV.tcl -notrace
